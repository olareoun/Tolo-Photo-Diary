CUORE.Matchers = {
    ...
    toHaveSameLength: function(toCompare) {
        this.message = function() {
            return "Expected " + this.actual.length + " to have the same length  " + toCompare.length;
        }
        return this.actual.length == toCompare.length;
    }
};