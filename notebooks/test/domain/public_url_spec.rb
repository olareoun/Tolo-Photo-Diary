...
describe 'Public Url' do
	...
	it 'has name, notebook and host when created with a correct evernote public notebook url' do
		publicUrl = Notebooks::PublicUrl.new('https://www.evernote.com/pub/olareoun/mipublicnotebook')
	...
	it 'raises BadArgumentException when nil url' do
		expect{Notebooks::PublicUrl.new(nil)}.to raise_error(BadArgumentException)
	end
